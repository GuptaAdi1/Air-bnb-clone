      ...
      <Link to={'/'} className="flex items-center gap-1">
       ...
       <div className="flex gap-2 border border-grey-300 rounded-full py-2 px-4 shadow-md shadow-gray-300">
        ...
        <button className="bg-primary text-white p-1 rounded-full">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="a-4 h-4">
          ...
          <Link to={user?'/account':'/login'} className="flex items-center gap-2 border border-grey-300 rounded-full py-2 px-4">
            ...
            <div className="bg-gray-500 text-white rounded-full boder border-gray-500 overflow-hidden">
             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="a-6 h-6 relative top-1">
